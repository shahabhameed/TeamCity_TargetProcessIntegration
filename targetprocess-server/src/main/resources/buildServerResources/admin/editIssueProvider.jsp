...
<div>
  <table class="editProviderTable">
    ...
    <tr>
       <th><label for="pattern" class="shortLabel">Bug Pattern: <l:star/></label></th>
       <td>
         <props:textProperty name="pattern" maxlength="100" style="width: 16em;"/>
         <span id="error_idPrefix" class="error"></span>
         <span class="fieldExplanation">Use regex, e.g. #(\d+)<bs:help file="Integrating+TeamCity+with+Issue+Tracker"/></span>
        </td>
    </tr>
  </table>
</div>
